...
/// All different constraint used for the list variables
class AllDifferentFWCPropagator : public Propagator {
 public:
    AllDifferentFWCPropagator(ssize_t index, CPVar* array);

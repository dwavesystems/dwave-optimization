...
class ArraySymbol(Symbol):
    ...
    def __add__(self, rhs: ArraySymbol) -> symbols.Add: ...
    def __bool__(self) -> typing.NoReturn: ...
    def __eq__(self, rhs: ArraySymbol) -> symbols.Equal: ...
    ...
    def __iadd__(self, rhs: ArraySymbol) -> symbols.NaryAdd: ...
    def __imul__(self, rhs: ArraySymbol) -> symbols.NaryMultiply: ...
    def __iter__(self) -> typing.Iterator[ArraySymbol]: ...
    def __le__(self, rhs: ArraySymbol) -> symbols.LessEqual: ...
    def __mod__(self, rhs: ArraySymbol) -> symbols.Modulus: ...
    def __mul__(self, rhs: ArraySymbol) -> symbols.Multiply: ...
    def __neg__(self) -> symbols.Negative: ...
    def __pow__(self, exponent: int) -> ArraySymbol: ...
    def __sub__(self, rhs: ArraySymbol) -> symbols.Subtract: ...
    def __truediv__(self, rhs: ArraySymbol) -> symbols.Divide: ...
    def all(self) -> symbols.All: ...
    def any(self) -> symbols.Any: ...
    def copy(self) -> symbols.Copy: ...
    def flatten(self) -> symbols.Reshape: ...
    def max(self) -> symbols.Max: ...
    def min(self) -> symbols.Min: ...
    def ndim(self) -> int: ...
    def prod(self) -> symbols.Prod: ...
    def reshape(self, *shape: _ShapeLike) -> symbols.Reshape: ...

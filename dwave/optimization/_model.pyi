...
from dwave.optimization import symbols
...
class _Graph:
    ...
    def from_file(
        ...
        *,
        substitute: None | collections.abc.Mapping[str, collections.abc.Callable[..., Symbol]] = None,
    ) -> typing.Self: ...
...
class ArraySymbol(Symbol):
    ...
    def __eq__(self, rhs: dwave.optimization.typing.ArraySymbolLike) -> symbols.Equal: ...  # type: ignore
    ...
    def __iter__(self) -> collections.abc.Iterator[ArraySymbol]: ...
    ...
    def reshape(self, *shape: dwave.optimization.typing.ShapeLike) -> ArraySymbol: ...
    def resize(
        self,
        shape: dwave.optimization.typing.ShapeLike,
        fill_value: None | float = None,
    ) -> symbols.Resize: ...
    def shape(self) -> tuple[int, ...]: ...
    def size(self) -> int | symbols.Size: ...
